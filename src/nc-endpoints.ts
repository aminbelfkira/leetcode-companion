...
// centralisé ici. Ces fonctions sont pures afin que toute la logique de
// détection puisse être vérifiée sans charger l'extension.
...
/** Au-delà, on ne parse pas le corps volumineux contenant notamment le code. */
const MAX_BODY_BYTES = 4_000_000;

/** Pages problème : /problems/{slug}, /problems/{slug}/question, etc. */
...
/** Normalise les URLs absolues et relatives avant de comparer leur chemin. */
...
/** Renvoie `null` si la requête n'est pas une véritable soumission. */
