// Métadonnées NeetCode via son endpoint interne, avec un repli prudent sur le
// DOM. À appeler depuis un content script isolé de même origine.
...
/**
 * `{"data":{"problemId":"duplicate-integer"}}` renvoie notamment le nom
 * et la difficulté. Aucun code utilisateur n'est demandé ou conservé.
 */
